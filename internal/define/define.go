...
// ***** 这些私密信息可以放在配置文件中，
var MailPassword = "NIGSSFOSFPEXKYVG"

// var MysqlDNS = os.Getenv("MysqlDNS")
var MysqlDNS = "root:root@"

// 讯飞

var HostUrl = "wss://spark-api.xf-yun.com/v3.5/chat"
var Appid = "80e3cc46"
var ApiSecret = "YzgwNzMzNzlhNTE2NzE5NTE0NmI5ZmRi"
var ApiKey = "ac6c495eaeffc3cb339025726c3c4987"

type ProblemBasic struct {
	Identity          string      `json:"identity"`           // 问题表的唯一标识
	Title             string      `json:"title"`              // 问题标题
	Content           string      `json:"content"`            // 问题内容
	ProblemCategories []int       `json:"problem_categories"` // 关联问题分类表 实际上是category的id
	MaxRuntime        int         `json:"max_runtime"`        // 最大运行时长
	MaxMem            int         `json:"max_mem"`            // 最大运行内存
	TestCases         []*TestCase `json:"test_cases"`         // 关联测试用例表
	OriginCode        string      `json:"origin_code"`        // 初始代码
}
